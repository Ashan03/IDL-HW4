...
class DecoderOnlyTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.target_embedding    = nn.Embedding(num_classes, d_model, padding_idx=0)
    ...
    def forward(self, padded_targets: torch.Tensor, target_lengths: Optional[torch.Tensor] = None) -> Tuple[torch.Tensor, dict]:
        ...
        x = self.target_embedding(padded_targets) * (self.target_embedding.embedding_dim ** 0.5)
...
class EncoderDecoderTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.target_embedding    = nn.Embedding(num_classes, d_model, padding_idx=0) # Target embedding
    ...
    def decode(
        ...
        x_dec = self.target_embedding(padded_targets) * (self.target_embedding.embedding_dim ** 0.5)
